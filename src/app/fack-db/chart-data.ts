export class ChartDB {
  ...
  public static trafficCAC = {
    ...
    colors: ['#1abc9c', '#0e9e4a', '#00acc1', '#ffa21d', '#ff5252', '#7759de'],
  ...
  public static bar4CAC = {
    ...
    colors: ['#1abc9c', '#00acc1', '#0e9e4a', '#ffa21d', '#ff5252'],
    stroke: {
      width: 1,
      colors: ['#fff']
    },
  ...
  public static scatter1CAC = {
    ...
    colors: ['#1abc9c', '#0e9e4a', '#ff5252', '#ffa21d', '#00acc1'],
    series: [{
      name: 'SAMPLE A',
      data: [
        [16.4, 5.4],
